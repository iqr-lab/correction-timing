...
class pgoal():
    def __init__(self, timing_ratio, split, target, shape, rep):
        ...
        with open(f"./KLDs_leaving/"+str(int(100*self.timing_ratio))+
...
if __name__ == "__main__":
    ...
    pg = pgoal(timing_ratio=args.timing_ratio, split = args.split, target = args.target, shape = args.shape, rep = args.repeat)