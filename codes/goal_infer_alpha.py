...
class pgoal():
    def __init__(self, timing_ratio, split, target, shape, rep, alpha, t):
        ...
        # self.plot_xy_goal_distribution(normalized_probs=normalized_powered_pwhens, x_vals=i_vals, y_vals=j_vals)
        ...
        ap = self.alpha
        combined = (normalized_all_pdfs)**(1-ap) * (normalized_powered_pwhens)**ap
