...
class extract_features():
    def __init__(self, timing_ratio, q, r):
        ...
        with open(f'../features/corrected_features_{str(int(100*self.timing_ratio))}.pkl', 'rb') as file: # all the data
    ...
    def get_features_corrected(self):
        ...
        with open(f"../features/sampled/sampled_{str(int(100*self.timing_ratio))}_finer/{key_str}.pkl", 'wb') as f: #abosulte path here for the scratch folder
