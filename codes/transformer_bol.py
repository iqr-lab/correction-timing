...
class transformer_train:
    ...
    def training_transformer_masked_with_val(
        ...
        checkpoint = tf.keras.callbacks.ModelCheckpoint(
                filepath=f'../goal_infer_files/when_weights/temp_models/best_transformer_b_model_{str(int(100*self.timing_ratio))}_{str(int(self.rep))}.keras',  # can end in .keras
        ...
        # --- Load best weights ---
        model.load_weights(f'../goal_infer_files/when_weights/temp_models/best_transformer_b_model_{str(int(100*self.timing_ratio))}_{str(int(self.rep))}.keras')
        model.save_weights('../goal_infer_files/when_weights/model_weights_bol/transformer_all_'+str(int(100*self.timing_ratio))+'_'+str(int(self.rep))+'.weights.h5')
...
if __name__ == "__main__":
    ...
    with open(f"../results/evaluation_bol/"+str(int(100*args.timing_ratio))+'_'+str(int(100*args.split))+'_'+str(int(args.repeat))+".pkl", "wb") as f:
