...
# train the transformer for ablation, one less feature at a time.
...
class transformer_train:
    def __init__(self, timing_ratio, split, rep, de):
    ...
    def devide_data(self, ind): #50/50 ind is the length of teh corrected data
        ...
        input_data_all = np.delete(input_data, self.de, axis=-1)
